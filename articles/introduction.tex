...
Most of the proofs consist in equational rewriting, with most steps consisting in term reduction, application of known laws and of previously proved lemmas.
...
This doesn't exclude the possibility that monsters would form a monad with a different implementation of joint.
