...
\guardf : \stream{M}\,A \rightarrow \stream{M}\,A
& f : A\times \stream{M}\,A \rightarrow A\times \stream{M}\,A \\
\guardf\,m = \mcons\,(M\,f\,m)
& f\,\langle a, \sigma \rangle = \langle \cdots, \guardf\,\cdots \rangle
\end{array}
$$
where the displayed occurrence of $\guardf$ in the body of $f$ is the only recursive call, and the dots can be any expressions not containing $\guardf$.
