...
(Formally, we can rewrite the definition, using the previous characterization of the monster lifting of a binary operator, to reduce it to a syntactically guarded form.)
