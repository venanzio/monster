...
(Notice that the expression can be further simplified to $\mcons\, (\apure_M\, \langle a, \apure_{\stream{M}}\,a \rangle)$.)

This shows in general that the second arguments of $(\fcons)$ and $(\acons)$, when definitions are expanded, are guarded by the constructor $\mcons$.
