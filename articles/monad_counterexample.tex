...
Our naive implementation of $\join$ takes the `diagonal' to flatten a monster of monsters. This means taking the first element of the first monster, the second element of the second monster, and so on. 
...
\vcomm{The above definition is difficult to understand. A reader could question whether it is a meaninful realization of the ``diagonal'' idea.
Below I attempt a more intuitive definition. It still has the defect that it mixes join and bind versions of monad.
}
...
The formal definition of $\join$ is as follows:
...
$$
\vcomm{Where does this law come from? The laws as we formulated them are in term of bind.}
