...
However, Haskell doesn't distinguish between the two: it has no $\codata$ keyword and the \hcode{data} definitions define types with potentially infinite elements.
So \hcode{data} in Haskell really means $\codata$.
