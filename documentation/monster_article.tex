...
%State machine function interpretations:
%- filterM - if an output doesn't fulfil the predicate, feeds the same input back into the next function, until a %'good' output is reached
%- 
