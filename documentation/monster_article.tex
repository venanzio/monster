...
We instantiate the abstract MonStr type with several common monads (Maybe, List, Reader, State, IO) and show that we obtain well-known data structures.
Maybe-monsters are lazy lists, List-monsters are non-well-founded finitely branching trees, Reader-monsters are finite state machines, IO-monsters are interactive processes.
