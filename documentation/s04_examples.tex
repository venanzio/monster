...
The first line of the \verb+do+ statement won't return if the $\io$ action \verb+p+ is non-terminating and strict. \\
...
To show this, there is an implementation of Conway's game of life included in the attached code. This demo uses a kind of Zipper comonad \cite{huet_zipper} instead of store for some more efficiency, but the type used is isomorphic to \verb+Store (Int,Int) Bool+.
