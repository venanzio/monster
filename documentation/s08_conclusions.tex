...
The difference is only that there is no first 'unguarded' element in a monadic stream \ccomm{Is there a better way of putting this?}, but this is enough make them function quite differently when instantiated with the same monads. \\
...
\ccomm{Should we leave it there, or does there need to be one more paragraph to tie things up - personally I feel like what needs to be said has already been said}